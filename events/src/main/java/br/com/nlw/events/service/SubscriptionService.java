...
public class SubscriptionService {
    ...
    public SubscriptionResponse createNewSubscription(String eventName, User user, Integer userId) {
        ...
        if(userId != null){
            ...
            if(indicador == null) {
                throw new UserIndicadorNotFoundException("Usuário "+ userId +" indicado não existe");
            }
        }
        ...
        if (tmpSub != null){ //caso alternativo 3
            throw new SubscriptionConflictException("Já existe inscrição apra o usuário" + userRec.getName() + " no evento " + evt.getTitle());
        }
    ...
    public SubscriptionRankingByUser getRankingByUser(String prettyName, Integer userId){
        ...
        if (item == null) {
            throw new UserIndicadorNotFoundException("Não há isncrições com indicação do usuário " + userId);
        }
